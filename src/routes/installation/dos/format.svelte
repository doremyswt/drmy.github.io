...
<div class="absolute inset-0 bg-[rgb(2,7,176)] overflow-hidden font-Levi">
    ...
    <div class="mt-6 sm:mt-12 text-sm sm:text-xl text-slate-400">
        <p class="text-center">Please wait while Setup formats the partition</p>
        <p class="mt-2 sm:mt-4 text-center">C: Partition1 [New (Raw)] &nbsp;&nbsp;&nbsp; 10229 MB (10228 MB free)</p>
        <p class="mt-2 sm:mt-4 text-center">On 10237 MB Disk 0 at Id 0 on bus 0 on atapi [MBR]</p>
